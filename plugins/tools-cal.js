...
if (!text) {
return m.reply(`ඞ Por favor, ingresa una ecuación.`)
}
...
await m.reply(`ඩා Ejercicio: *${format}* = _${result}_`)
await m.react('✔️')
} catch (e) {
await m.react('✖️')
return m.reply(`⚠︎ Formato incorrecto, solo 0-9 y símbolo -, +, *, /, ×, ÷, π, e, (, ) que puedes usar.`)
}}
