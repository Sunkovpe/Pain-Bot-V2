...
let quoted = m.quoted
if (!quoted) return conn.reply(m.chat, `ඞ Por favor, responde a un mensaje de una sola vez "ViewOnce" para ver su contenido.`, m)
try {
await m.react('🕒')
...
if (!stream) return conn.reply(m.chat, `⚠︎ No se pudo descargar el contenido.`, m)  
