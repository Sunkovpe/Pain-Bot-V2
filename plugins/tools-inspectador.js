...
case isCommand1:
let inviteCode
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el enlace de grupo/comunidad o canal.`, m)
...
await conn.reply(m.chat, `ඩා ${botname} ya ha empezado a seguir el canal *${chtitle}*.`, m) 
} catch (e) {
reportError(e)
}
break
...
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
ch
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp que quiere que el bot deje de seguir.\n\nPuede obtener el ID usando el comando:\n${usedPrefix}superinspect enlace${txtBotAdminCh}`, m)
if (text.includes("@newsletter")) {
ch = text
} else {
ch = await conn.newsletterMetadata("invite", channelUrl).then(data => data.id).catch(e => null)
...
await conn.reply(m.chat, `ඞ ${botname} ha dejado de seguir el canal *${chtitle}*.`, m) 
} catch (e) {
reportError(e)
}
break
...
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
ch
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp que quiere que el bot silencie las actualizaciones.\n\nPuede obtener el ID usando el comando:\n*${usedPrefix}superinspect enlace${txtBotAdminCh}`, m)
if (text.includes("@newsletter")) {
ch = text
} else {
ch = await conn.newsletterMetadata("invite", channelUrl).then(data => data.id).catch(e => null)
...
await conn.reply(m.chat, `ඞ ${botname} ha silenciado las notificaciones para el canal *${chtitle}* con éxito.`, m) 
} catch (e) {
reportError(e)
}
break
...
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
ch
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp que quiere que el bot active las actualizaciones.\n\nPuede obtener el ID usando el comando:\n*${usedPrefix}superinspect* enlace${txtBotAdminCh}`, m)
if (text.includes("@newsletter")) {
ch = text
} else {
ch = await conn.newsletterMetadata("invite", channelUrl).then(data => data.id).catch(e => null)
...
await conn.reply(m.chat, `ඞ ${botname} ha dejado de silenciar las notificaciones para el canal *${chtitle}* con éxito.`, m) 
} catch (e) {
reportError(e)
}
break
...
return await conn.reply(m.chat, `ඞ *Responda a una imagen jpg/png.*`, m)
}} else { 
const imageUrlRegex = /(https?:\/\/[^\s]+?\.(?:jpe?g|png))/
if (!match2 && !text.match(imageUrlRegex)) return await conn.reply(m.chat, `ඞ *Agregué el enlace jpg/png después del ID del canal.*`, m)
try {
...
await conn.sendMessage(ch, { text: `ඞ ${botname} ha cambiando la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "【 ✧ 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 ✧ 】",
body: 'ඩා 𝙽𝚞𝚎𝚟𝚊 𝚒𝚖𝚊𝚐𝚎𝚗 𝚍𝚎 𝚙𝚎𝚛𝚍𝚒𝚕 𝚍𝚎𝚕 𝚌𝚊𝚗𝚊𝚕.',
thumbnailUrl: pp,
sourceUrl: redes,
mediaType: 1,
showAdAttribution: false,
...
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
ch
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp que quiere que el bot elimine la imagen del canal.\n\nPuede obtener el ID usando el comando:\n${usedPrefix}superinspect enlace${txtBotAdminCh}`, m)
if (text.includes("@newsletter")) {
ch = text
} else {
ch = await conn.newsletterMetadata("invite", channelUrl).then(data => data.id).catch(e => null)
...
await conn.sendMessage(ch, { text: `ඞ ${botname} ha eliminado la imagen del canal *${chtitle}* con éxito.`, contextInfo: {
externalAdReply: {
title: "【 ✧ 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 ✧ 】",
body: 'ඩා 𝙸𝚖𝚊𝚐𝚎𝚗 𝚍𝚎 𝚙𝚎𝚛𝚏𝚒𝚕 𝚍𝚎𝚕 𝚌𝚊𝚗𝚊𝚕 𝚑𝚊 𝚜𝚒𝚍𝚘 𝚎𝚕𝚒𝚖𝚒𝚗𝚊𝚍𝚊',
thumbnailUrl: pp,
sourceUrl: redes,
mediaType: 1,
showAdAttribution: false,
...
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
ch
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp para que el bot reciba notificaciones en tiempo real.\n\nPuede obtener el ID usando el comando:\n*${usedPrefix}superinspect enlace${txtBotAdminCh}`, m)
if (text.includes("@newsletter")) {
ch = text
} else {
ch = await conn.newsletterMetadata("invite", channelUrl).then(data => data.id).catch(e => null)
...
await conn.reply(m.chat, `ඞ ${botname} recibirá notificaciones del canal *${chtitle}*`, m) 
} catch (e) {
reportError(e)
}
break
...
ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp seguido de un espacio y la opción del modo de reacciones para el canal.
...
case isCommand10:
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp para que el bot modifique el nombre del canal.*\n\n
*Parámetros de uso:
...
await conn.sendMessage(ch, { text: `ඩා ${botname} ha cambiado el nombre del canal *${name}*\n\n*Anterior nombre:* ${chtitle}\n*Nuevo nombre:* ${name}`, contextInfo: {
externalAdReply: {
title: "【 ✧ 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 ✧ 】",
body: 'ඩා 𝚄𝚗 𝚗𝚞𝚎𝚟𝚘 𝚗𝚘𝚖𝚋𝚛𝚎 𝚙𝚊𝚛𝚊 𝚎𝚕 𝚌𝚊𝚗𝚊𝚕.',
thumbnailUrl: pp,
sourceUrl: redes,
mediaType: 1,
showAdAttribution: false,
...
case isCommand11:
if (!isOwner || !isROwner) return await conn.reply(m.chat, `✧ No tienes permiso para usar este comando.`, m)
if (!text) return await conn.reply(m.chat, `ඞ Por favor, ingrese el ID o enlace de un canal de WhatsApp para que el bot modifique la descripción del canal.\n\n
Parámetros de uso:
...
await conn.sendMessage(ch, { text: `ඞ ${botname} ha modificado la descripción del canal *${chtitle}*`, contextInfo: {
externalAdReply: {
title: "【 ✧ 𝐍𝐎𝐓𝐈𝐅𝐈𝐂𝐀𝐂𝐈𝐎́𝐍 ✧ 】",
body: 'ඩා 𝚞𝚗𝚊 𝚗𝚞𝚎𝚟𝚊 𝚍𝚎𝚜𝚌𝚛𝚒𝚙𝚌𝚒𝚘́𝚗 𝚊𝚕 𝚌𝚊𝚗𝚊𝚕.',
thumbnailUrl: pp,
sourceUrl: redes,
mediaType: 1,
showAdAttribution: false,
