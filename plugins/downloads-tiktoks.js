...
if (!text) return conn.reply(m.chat, 'ඞ Por favor, ingresa un término de búsqueda o el enlace de TikTok.', m)
...
if (!data?.play) return conn.reply(m.chat, '⚠︎ Enlace inválido o sin contenido descargable.', m)
...
if (results.length < 2) return conn.reply(m.chat, 'ඩා Se requieren al menos 2 resultados válidos con contenido.', m)
