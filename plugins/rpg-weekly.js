...
if (!db.data.chats[m.chat].economy && m.isGroup) return m.reply(`ඩා Los comandos de *Economía* están desactivados en este grupo.\n\nUn *administrador* puede activarlos con el comando:\n» *${usedPrefix}economy on*`)
...
return conn.reply(m.chat, `⚠︎ Ya has reclamado tu recompensa semanal.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
}
...
conn.reply(m.chat, `ඩා Has reclamado tu recompensa semanal de *¥${coins.toLocaleString()} ${currency}* (Semana *${user.weeklyStreak}*)\n${msg}`, m)
}
