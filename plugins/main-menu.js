...
> ඩා Comandos de *Economía* para ganar dinero.
✎ *#w • #work • #trabajar*
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐃𝐄𝐒𝐂𝐀𝐑𝐆𝐀𝐒\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos de *Descargas* para descargar archivos de varias fuentes.
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐁𝐎𝐓\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos para registrar tu propio Bot.
✎ *#qr • #code*
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐀𝐉𝐔𝐒𝐓𝐄𝐒\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos de *Útilidades*.
✎ *#help • #menu*
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐏𝐄𝐑𝐅𝐈𝐋𝐄𝐒\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos de *Perfil* para ver y configurar tu perfil.
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐀𝐃𝐌\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos para *Administradores* de grupos.
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐑𝐄𝐀𝐂𝐂𝐈𝐎́𝐍\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
> ඩා Comandos de reacciones de anime.
...
╭┈ࠢ͜─ׄ֟፝͜─ׄ͜─ׄ͜╴𐔌 \`𝐍𝐒𝐅𝐖\` 𐦯╶͜─ׄ͜─ׄ֟፝͜─ׄ͜─ׄ͜
