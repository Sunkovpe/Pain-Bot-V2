...
if (!text) return m.reply(`ඞ Por favor, escribe el nombre de la canción para obtener la letra`)
try {
await m.react('🕒')
...
await m.react('✖️')
return m.reply('⚠︎ No se encontró la letra de la canción')
}
let { title, artists, lyrics, image, url } = json.data
let caption = `ඩා *Título:* ${title}\n○ *Artista:* ${artists}\n○ *Letra:*\n\n${lyrics}`
