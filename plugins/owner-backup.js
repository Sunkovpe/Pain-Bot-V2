...
if (!who) return conn.sendMessage(m.chat, { text: `ඞ Formato de usuario no reconocido.` }, { quoted: m })
...
conn.sendMessage(m.chat, { text: `ඞ Éxito. Todos los datos del usuario @${userNumber} fueron eliminados.`, mentions: [who] }, { quoted: m })
break
}
...
bot[type] = enable
return conn.reply(m.chat, `ඞ Has *${enable ? 'activado' : 'desactivado'}* el modo *${type}* para el Socket.`, m)
}
