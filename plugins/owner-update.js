...
if (messager.includes('ඞ Ya está cargada la actualización.')) messager = 'ඩා Los datos ya están actualizados a la última versión.'
if (messager.includes('ꕥ Actualizando.')) messager = 'ඞ Procesando, espere un momento mientras me actualizo.\n\n' + stdout.toString()
await m.react('✔️')
