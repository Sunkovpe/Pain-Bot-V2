...
const pp = await conn.profilePictureUrl(userId, 'image').catch(() => 'https://files.catbox.moe/xd4vrj.jpeg')
...
const caption = `ඩා Adiós de *"_${groupMetadata.subject}_"*\nඞ _Usuario_ » ${username}\n● ${mensaje}\n➣ _Ahora somos ${groupSize} Miembros._\n¤ Fecha » ${fecha}\n> *➣ Puedes usar _#menu_ para ver la lista de comandos.*`
return { pp, caption, mentions: [userId] }
}
let handler = m => m
