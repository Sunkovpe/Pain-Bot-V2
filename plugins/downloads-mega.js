...
if (!text) {
return conn.reply(m.chat, `ඞ Por favor, envia un link de MEGA para descargar el archivo.`, m)
}
try {
await m.react('🕒')
...
return conn.reply(m.chat, `⚠︎ El archivo es demasiado pesado (Peso máximo: 300MB).`, m)
}
