...
if (!text) return m.reply("ඞ Por favor, proporciona el nombre de una canción o artista.")
try {
await m.react('🕒')
...
if (!result || !result.url) throw new Error("⚠︎ No se encontraron resultados.")
trackUrl = result.url
