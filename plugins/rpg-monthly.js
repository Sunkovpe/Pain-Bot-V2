...
return conn.reply(m.chat, `⚠︎ Ya has reclamado tu recompensa mensual.\n> Puedes reclamarlo de nuevo en *${wait}*`, m)
}
...
conn.reply(m.chat, `ඩා  Has reclamado tu recompensa mensual de *+${coins.toLocaleString()} ${currency}* (Mes *${user.monthlyStreak}*)\n${msg}`, m)
}
