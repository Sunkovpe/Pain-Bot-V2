...
const allowedLinks = ['https://whatsapp.com/channel/0029Vb5Vinf72WTo11c5hJ3O']
...
await conn.reply(m.chat, `> ඞ Se ha eliminado a *${global.db.data.users[m.key.participant].name || 'Usuario'}* del grupo por \`Anti-Link\`, no permitimos enlaces de *${isChannelLink ? 'canales' : 'otros grupos'}*.`, null)
